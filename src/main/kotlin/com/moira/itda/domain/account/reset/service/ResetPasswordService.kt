package com.moira.itda.domain.account.reset.service

import com.moira.itda.domain.account.reset.dto.request.ResetPasswordRequest
import com.moira.itda.domain.account.reset.mapper.ResetPasswordMapper
...
class ResetPasswordService(
    ...
    private val mapper: ResetPasswordMapper
) {
