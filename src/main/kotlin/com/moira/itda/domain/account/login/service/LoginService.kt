package com.moira.itda.domain.account.login.service
...
import com.moira.itda.domain.account.login.mapper.LoginMapper
...
class LoginService(
    ...
    fun login(
        ...
        // [6] AccessToken 리턴
        return TokenResponse(accessToken = atk, refreshToken = rtk)
    }
}