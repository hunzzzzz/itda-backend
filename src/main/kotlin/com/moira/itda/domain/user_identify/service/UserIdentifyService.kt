package com.moira.itda.domain.user_identify.service
...
class UserIdentifyService(
     ...
     */
    @Transactional
    fun checkIdentifyCode(request: IdentifyCheckRequest): IdentifyInfoResponse? {
        val phoneNumber = request.phoneNumber
        ...
        return IdentifyInfoResponse(name = name, phoneNumber = phoneNumber, ci = ci)
    }
}