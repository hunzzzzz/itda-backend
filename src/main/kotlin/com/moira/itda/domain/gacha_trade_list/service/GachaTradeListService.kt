package com.moira.itda.domain.gacha_trade_list.service

import com.moira.itda.domain.gacha_trade_list.dto.response.TradeListContentResponse
import com.moira.itda.domain.gacha_trade_list.dto.response.TradeListPageResponse
import com.moira.itda.domain.gacha_trade_list.mapper.GachaTradeListMapper
...
@Service
class GachaTradeListService(
    private val mapper: GachaTradeListMapper,
