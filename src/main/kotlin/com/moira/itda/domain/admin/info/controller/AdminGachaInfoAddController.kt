...
class AdminGachaInfoAddController(
     ...
     */
    @IsAdmin
    @GetMapping("/api/admin/gacha/info/add")
     ...
     */
    @IsAdmin
    @GetMapping("/api/admin/gacha/info/add/{infoId}")
    fun getAddInfo(@PathVariable infoId: String): ResponseEntity<AdminGachaInfoAddDetailResponse> {
        val response = adminGachaInfoAddService.getAddInfo(infoId)
