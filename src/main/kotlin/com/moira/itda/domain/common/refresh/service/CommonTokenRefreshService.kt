package com.moira.itda.domain.common.refresh.service

import com.moira.itda.domain.common.refresh.dto.response.NewTokenResponse
import com.moira.itda.domain.common.refresh.mapper.CommonTokenRefreshMapper
...
@Service
class CommonTokenRefreshService(
    private val cookieHandler: CookieHandler,
    private val jwtProvider: JwtProvider,
    private val mapper: CommonTokenRefreshMapper
) {
    /**
     * 토큰 재발급
        ...
        jwtProvider.validateToken(refreshToken)
            .onSuccess { claims ->
                if (claims != null) {
                    ...
                    return NewTokenResponse(accessToken = atk, refreshToken = rtk)
                }
            }
            .onFailure {
