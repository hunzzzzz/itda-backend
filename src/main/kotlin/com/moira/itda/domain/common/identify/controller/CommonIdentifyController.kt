package com.moira.itda.domain.common.identify.controller
...
import com.moira.itda.domain.common.identify.service.CommonIdentifyService
 ...
 */
@RestController
class CommonIdentifyController(
    private val service: CommonIdentifyService
) {
    /**
     * 본인인증
     */
    ...
    ): ResponseEntity<IdentifyResponse?> {
