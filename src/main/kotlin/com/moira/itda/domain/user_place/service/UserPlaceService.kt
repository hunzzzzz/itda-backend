package com.moira.itda.domain.user_place.service
...
import com.moira.itda.domain.user_place.mapper.UserPlaceMapper
...
class UserPlaceService(
    private val mapper: UserPlaceMapper
) {
    companion object {
     ...
     */
    @Transactional
    fun add(userId: String, request: UserPlaceRequest) {
        // [1] name 중복 여부 검증
    ...
    fun getList(userId: String): List<UserPlaceResponse> {
