package com.moira.itda.domain.user_login.service
...
import com.moira.itda.domain.user_login.mapper.UserLoginMapper
...
class UserLoginService(
    ...
    private val userLoginHistoryService: UserLoginHistoryService,
    private val mapper: UserLoginMapper
) {
    /**
     * 로그인
     */
    ...
    fun login(
        ...
        // [3-4] 그 외의 경우, 로그인 성공 기록 저장
            ...
            userLoginHistoryService.success(user = user, ipAddress = ipAddress, userAgent = userAgent)
        }
